...
\titre{Développement d'un framework de suivi et d'évaluation de l'impact à travers un data warehouse sémantique pour les meta-organisations}
...
\motscles{data warehouse, web sémantique, meta-organisation, mesure d'impact}
